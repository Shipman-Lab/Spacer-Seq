...
workbook_136_AB = xlsxwriter.Workbook('136_AB_sim_comp2.xlsx')
sheet1_136_AB = workbook_136_AB.add_worksheet()
sheet1_136_AB.write(0, 0, 'A/N')
sheet1_136_AB.write(1, 0, 'B/N')
sheet1_136_AB.write(2, 0, 'A/B')
sheet1_136_AB.write(3, 0, 'composite')

row, col = 0, 1
for rule in values_AB:
    for score in rule:
        sheet1_136_AB.write(row, col, score)
        col += 1
    row += 1
    col = 1

workbook_136_AB.close()
