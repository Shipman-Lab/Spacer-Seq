...
workbook_134_BA = xlsxwriter.Workbook('134_BA_sim_comp2.xlsx')
sheet1_134_BA = workbook_134_BA.add_worksheet()
sheet1_134_BA.write(0, 0, 'A/N')
sheet1_134_BA.write(1, 0, 'B/N')
sheet1_134_BA.write(2, 0, 'A/B')
sheet1_134_BA.write(3, 0, 'composite')

row, col = 0, 1
for rule in values_BA:
    for score in rule:
        sheet1_134_BA.write(row, col, score)
        col += 1
    row += 1
    col = 1

workbook_134_BA.close()
