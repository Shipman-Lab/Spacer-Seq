...
data_BA = []
for i in range(7):
	data_AB.append([run_single_experiment(population_size = 1 * (10 ** i),
	order_of_expression='A_before_B')['composite_score'] for j in range(100)])
	data_AB.append([run_single_experiment(population_size = 2 * (10 ** i),
	order_of_expression='A_before_B')['composite_score'] for j in range(100)])
	data_AB.append([run_single_experiment(population_size = 3 * (10 ** i),
	order_of_expression='A_before_B')['composite_score'] for j in range(100)])
	data_AB.append([run_single_experiment(population_size = 6 * (10 ** i),
	order_of_expression='A_before_B')['composite_score'] for j in range(100)])


	data_BA.append([run_single_experiment(population_size = 1 * (10 ** i),
	order_of_expression='B_before_A')['composite_score'] for j in range(100)])
	data_BA.append([run_single_experiment(population_size = 2 * (10 ** i),
	order_of_expression='B_before_A')['composite_score'] for j in range(100)])
	data_BA.append([run_single_experiment(population_size = 3 * (10 ** i),
	order_of_expression='B_before_A')['composite_score'] for j in range(100)])
	data_BA.append([run_single_experiment(population_size = 6 * (10 ** i),
	order_of_expression='B_before_A')['composite_score'] for j in range(100)])
...
workbook_134 = xlsxwriter.Workbook('134_sim_subsample_comp2.xlsx')
sheet1_134_AB = workbook_134.add_worksheet()
sheet2_134_BA = workbook_134.add_worksheet()

sheet1_134_AB.write(0, 0, 'Reads')
sheet2_134_BA.write(0, 0, 'Reads')
row, col = 1, 0
for i in range(len(data_AB)//4):
	sheet1_134_AB.write(row, col, 1 * (10 ** i))
	row += 1
	sheet1_134_AB.write(row, col, 2 * (10 ** i))
	row += 1
	sheet1_134_AB.write(row, col, 3 * (10 ** i))
	row += 1
	sheet1_134_AB.write(row, col, 6 * (10 ** i))
	row += 1


row, col = 1, 0
for i in range(len(data_BA)//4):
	sheet2_134_BA.write(row, col, 1 * (10 ** i))
	row += 1
	sheet2_134_BA.write(row, col, 2 * (10 ** i))
	row += 1
	sheet2_134_BA.write(row, col, 3 * (10 ** i))
	row += 1
	sheet2_134_BA.write(row, col, 6 * (10 ** i))
	row += 1
